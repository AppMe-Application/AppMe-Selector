...
import com.appme.story.engine.graphics.drawable.MaterialProgressDrawable;
...
public class LoadToastView extends ImageView {
    ...
    public LoadToastView(Context context) {
        ...
        successPaint.setColor(getResources().getColor(R.color.accent_green));
        errorPaint.setColor(getResources().getColor(R.color.accent_red));
