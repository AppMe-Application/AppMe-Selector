package com.appme.story.engine.app.folders.selector.models;
...
public class MarkedItemList {
    private static HashMap<String,FilePickerItem> ourInstance = new HashMap<>();

    public static void addSelectedItem(FilePickerItem item) {
    ...
    public static void addSingleFile(FilePickerItem item) {
        ourInstance = new HashMap<>();
        ourInstance.put(item.getLocation(),item);
    }
